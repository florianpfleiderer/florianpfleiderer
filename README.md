...
- <img align="center" src="assets/coffee-app.png" width="65" style="padding-bottom: 15px; padding-left: 15px; display: block; margin-left: auto; margin-right: auto;"><a href="https://github.com/florianpfleiderer/coffee-app">React x Flask Application</a> – A containerised application using the react and flask frameworks and SQLite for local database management.
